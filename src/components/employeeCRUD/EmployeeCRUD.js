...
export default function EmployeeCRUD() {
  ...
  const editEmp = (eidToEdit) => {
    const permArray = initialEmployees.filter((emp) => {
      return emp.eId == eidToEdit;
    });
    setEmployees(permArray)
  }
      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-8">
            <ListEmployee employees={employees} deleteEmp={deleteEmp} editEmp={editEmp}/>
          </div>
